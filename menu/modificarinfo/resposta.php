...
if($_SERVER['REQUEST_METHOD']=='GET'){
	if(isset($_GET['m'])){
		switch ($_GET['m']) {
            case 0:
                $response="Informações alteradas com Sucesso!";
                break;
            case 1:
                $response="Falha na alteração das Informações!";
                break;
            case 2:
...
<body>
    <div style="margin:1%">
        ...
        <a class="btn btn-fatec-red btn-lg btn-block rounded-top" href="./index.php" role="button">Voltar na Modificação</a>
