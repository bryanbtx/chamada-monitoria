...
if($_SERVER['REQUEST_METHOD']=='GET'){
    if(isset($_GET['m'])){
        switch ($_GET['m']) {
            case 0:
                $response="Horário Adicionado com Sucesso!";
                break;
            case 1:
...
<body>
    <div style="margin:1%">
        ...
        <a class="btn btn-fatec-red btn-lg btn-block rounded-top" href="./index.php" role="button">Voltar para Adicionar mais Horário</a>
